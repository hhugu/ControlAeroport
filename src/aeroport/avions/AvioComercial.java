...
public class AvioComercial extends Avio {
   ...
   protected static final int VEL_PISTA = 20;
   protected static final int VEL_VOL = 500;

    public AvioComercial(Aeroport aeroport, String idAvio, Carrer way, Direction direction, Finger finger, ArrayList<String> rutaAlFinger, ArrayList<String> rutaDespegue) {
